...
public class CpAbeController {
    ...
    public void encryptMessage(String pubfile, String policy, String inputfile, String encfile)
    	throws Exception {
    	    cpabe.enc(pubfile, policy, inputfile, encfile);
    }
	
    public void decryptMessage(String pubfile, String prvfile, String encfile, String decfile)
    	throws Exception {
    ...
    private String deciphering(JSONObject j, Cipher cipher, int i) 
    	throws JSONException, IllegalBlockSizeException, BadPaddingException {
