...
public class BlogracyBullyAnswerMessage extends BlogracyDataMessageBase {

	public final static String ID = "ID_BLOGRACYMESSAGE_BlogracyBullyAnswerMessage";

	public BlogracyBullyAnswerMessage(String senderUserId, byte[] senderID, int hops, String content) {
	...
	public Message create(ByteBuffer data) throws MessageException {
		...
		try {
			...
			BlogracyBullyAnswerMessage message = new BlogracyBullyAnswerMessage(uid, senderID, hops, content);
	...
	public BlogracyDataMessageBase copy() {
		BlogracyBullyAnswerMessage message = new BlogracyBullyAnswerMessage(getSenderUserId(), getSenderPeerID(), getNbHops(), getContent());
