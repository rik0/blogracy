...
public class BlogracyDataMessageBase implements BlogracyDataMessage {
	...
	public byte[] getSenderPeerID() {return senderID;}

	public String getSenderUserId() {return senderUserId;}

	public int getNbHops() {return hops;}
	
	public void setNbHops(int nbHops) {	hops = nbHops;	}

	public String getContent() {return content;}


	public String getID() {return BlogracyDataMessageBase.ID_BLOGRACY_MESSAGE;}
