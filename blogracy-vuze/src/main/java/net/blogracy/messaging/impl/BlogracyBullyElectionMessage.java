...
public class BlogracyBullyElectionMessage extends BlogracyDataMessageBase {
	public final static String ID = "ID_BLOGRACYMESSAGE_BlogracyBullyElectionMessage";

	public BlogracyBullyElectionMessage(String senderUserId, byte[] senderID, int hops, String content) {
	...
	public Message create(ByteBuffer data) throws MessageException {
		...
		try {
			...
			BlogracyBullyElectionMessage message = new BlogracyBullyElectionMessage(uid, senderID, hops, content);
	...
	public BlogracyDataMessageBase copy() {
		BlogracyBullyElectionMessage message = new BlogracyBullyElectionMessage(getSenderUserId(), getSenderPeerID(), getNbHops(), getContent());
